...
Ao trabalhar em tais projetos venho constantemente evoluindo minhas habilidades de programação (HTML, CSS, JavaScript, PHP, C, bash, etc.), mas também minhas habilidades interpessoais (pois preciso interagir com pessoas vindas de muitas nacionalidades diferentes). Eu também produzi bastante [documentação](https://docs.retroachievements.org/).
