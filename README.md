...
I've been constantly improving not only my coding skills (HTML/CSS/PHP/JavaScript/TypeScript/bash), but also my soft skills (as I need to interact with people coming from many different backgrounds/nationalities). I also produced a lot of [documentation](https://docs.retroachievements.org/).
